...
describe('header', () => {
  it('should render the correct header', () => {
    ...
    expect(screen.getByTestId('header-section').textContent).toEqual('Sand Crawler')
  })
})
...
describe('footer', () => {
  it('should render the correct footer', () => {
    render(<SwapiVehicle vehicle={vehicleResponse} />)
    expect(screen.getByTestId('footer-section').textContent).toEqual('Sand Crawler: (wheeled)')
  })
})
